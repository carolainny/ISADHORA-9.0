"object" == typeof navigator && function(e, t) {
    ...
    var N, R, j, $ = O.inspectSource, U = n.WeakMap, q = "function" == typeof U && /native code/.test($(U)), F = t((function(e) {
    ...
    )), D = 0, H = Math.random(), B = function(e) {
        return "Symbol(" + String(void 0 === e ? "" : e) + ")_" + (++D + H).toString(36)
    }, V = F("keys"), W = function(e) {
        return V[e] || (V[e] = B(e))
    }, z = {}, K = n.WeakMap;
    if (q) {
    ...
    var Z = {
      ...
      , ee = t((function(e) {
        ...
        (e.exports = function(e, t, r, a) {
            var o, l = !!a && !!a.unsafe, c = !!a && !!a.enumerable, u = !!a && !!a.noTargetGet;
            "function" == typeof r && ("string" != typeof t || v(r, "name") || L(r, "name", t),
            (o = i(r)).source || (o.source = s.join("string" == typeof t ? t : ""))),
            e !== n ? (l ? !u && e[t] && (c = !0) : delete e[t],
            c ? e[t] = r : L(e, t, r)) : c ? e[t] = r : I(t, r)
        }
      ...
      , he = function(e) {
        return function(t, i, n) {
            var s, r = f(t), a = le(r.length), o = function(e, t) {
                var i = ae(e);
      ...
      , pe = function(e, t) {
        var i, n = f(e), s = 0, r = [];
        for (i in n)
            !v(z, i) && v(n, i) && r.push(i);
        for (; t.length > s; )
            v(n, i = t[s++]) && (~de(r, i) || r.push(i));
        return r
    }
      ...
      , Pe = A.f
      , xe = function(e, t) {
        var i, s, r, a, o, l = e.target, c = e.global, u = e.stat;
    ...
    }, Ne = RegExp.prototype.exec, Re = F("native-string-replace", String.prototype.replace), je = Ne, $e = (_e = /a/,
    Oe = /b*/g,
    Ne.call(_e, "a"),
    Ne.call(Oe, "a"),
    0 !== _e.lastIndex || 0 !== Oe.lastIndex), Ue = Me.UNSUPPORTED_Y || Me.BROKEN_CARET, qe = void 0 !== /()??/.exec("")[1];
    ($e || qe || Ue) && (je = function(e) {
        var t, i, n, s, r = this, a = Ue && r.sticky, o = Le.call(r), l = r.source, c = 0, u = e;
        return a && (-1 === (o = o.replace("y", "")).indexOf("g") && (o += "g"),
        ...
        n[0] = n[0].slice(c),
        n.index = r.lastIndex,
        r.lastIndex += n[0].length) : r.lastIndex = 0 : $e && n && (r.lastIndex = r.global ? n.index + n[0].length : t),
        qe && n && n.length > 1 && Re.call(n[0], i, (function() {
    ...
    var De, He, Be = "process" == h(n.process), Ve = ne("navigator", "userAgent") || "", We = n.process, ze = We && We.versions, Ke = ze && ze.v8;
    ...
    var Ye = He && +He
      ...
      , et = function(e) {
        return v(Qe, e) && (Ge || "string" == typeof Qe[e]) || (Ge && v(Je, e) ? Qe[e] = Je[e] : Qe[e] = Ze("Symbol." + e)),
        Qe[e]
    }
      , tt = et("species")
      , it = !s((function() {
      ...
      , ot = function(e) {
        return function(t, i) {
            var n, s, r = String(m(t)), a = ae(i), o = r.length;
    ...
    !function(e, t, i, n) {
        ...
        if (!a || !o || "replace" === e && (!it || !nt || rt) || "split" === e && !at) {
            ...
            ee(RegExp.prototype, r, 2 == t ? function(e, t) {
        ...
        , function(e, n) {
            ...
            for (var f, g = "", y = 0, b = 0; b < p.length; b++) {
                m = p[b];
                for (var v = String(m[0]), w = bt(vt(ae(m.index), c.length), 0), k = [], T = 1; T < m.length; T++)
    ...
    )), Et = W("IE_PROTO"), At = Object.prototype, Ct = St ? Object.getPrototypeOf : function(e) {
        return e = ht(e),
        v(e, Et) ? e[Et] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? At : null
    }
    , Pt = et("iterator"), xt = !1;
    [].keys && ("next"in (Tt = [].keys()) ? (kt = Ct(Ct(Tt))) !== Object.prototype && (wt = kt) : xt = !0),
    (null == wt || s((function() {
        var e = {};
        return wt[Pt].call(e) !== e
    }
    ))) && (wt = {}),
    v(wt, Pt) || L(wt, Pt, (function() {
        return this
    }
    ));
    var Lt, It = {
    ...
    , Mt = ne("document", "documentElement"), Nt = W("IE_PROTO"), Rt = function() {}, jt = function(e) {
        ...
        $t = Lt ? function(e) {
            ...
            return e = null,
            t
        }(Lt) : ((t = T("iframe")).style.display = "none",
        Mt.appendChild(t),
        ...
        for (var i = me.length; i--; )
            delete $t.prototype[me[i]];
        return $t()
    };
    z[Nt] = !0;
    var Ut = Object.create || function(e, t) {
        var i;
        return null !== e ? (Rt.prototype = C(e),
        i = new Rt,
        Rt.prototype = null,
        i[Nt] = e) : i = $t(),
        void 0 === t ? i : Ot(i, t)
      ...
      , ei = function(e, t, i, n, s, r, a) {
        ...
        }, h = t + " Iterator", d = !1, p = e.prototype, m = p[Gt] || p["@@iterator"] || s && p[s], f = !Yt && m || u(s), g = "Array" == t && p.entries || m;
        if (g && (o = Ct(g.call(new e)),
        Kt !== Object.prototype && o.next && (Ct(o) !== Kt && (zt ? zt(o, Kt) : "function" != typeof o[Gt] && L(o, Gt, Zt)),
        Dt(o, h, !0))),
        s == Qt && m && m.name !== Qt && (d = !0,
        f = function() {
            return m.call(this)
        }
        ),
    ...
    ei(String, "String", (function(e) {
        ...
        var e, t = si(this), i = t.string, n = t.index;
        return n >= i.length ? {
            value: void 0,
            done: !0
        } : (e = ti(i, n),
    ...
    var ri = et("iterator")
      ...
      , ui = !li || s((function() {
        ...
        for (var i = ht(e), n = arguments.length, s = 1, a = ye.f, o = l.f; n > s; )
            for (var c, u = p(arguments[s++]), h = a ? _t(u).concat(a(u)) : _t(u), d = h.length, m = 0; d > m; )
                c = h[m++],
                r && !o.call(u, c) || (i[c] = u[c]);
        return i
    }
    : li
      , hi = function(e, t, i) {
    ...
    var bi = "[object z]" === String(yi)
      ...
      , Si = function(e) {
        if (null != e)
            return e[Ti] || e["@@iterator"] || Ht[ki(e)]
    }
      , Ei = function(e) {
        var t, i, n, s, r, a, o = ht(e), l = "function" == typeof this ? this : Array, c = arguments.length, u = c > 1 ? arguments[1] : void 0, h = void 0 !== u, d = Si(o), p = 0;
        if (h && (u = hi(u, c > 2 ? arguments[2] : void 0, 2)),
        null == d || l == Array && fi(d))
            for (i = new l(t = le(o.length)); t > p; p++)
                a = h ? u(o[p], p) : o[p],
                gi(i, p, a);
        else
            for (r = (s = d.call(o)).next,
            i = new l; !(n = r.call(s)).done; p++)
                a = h ? di(s, u, [n.value, p], !0) : n.value,
                gi(i, p, a);
        return i.length = p,
        i
    }
      ...
      , Oi = function(e, t, i) {
        var n = 0;
        for (e = i ? Li(e / 700) : e >> 1,
        e += Li(e / t); e > 455; n += 36)
            e = Li(e / 35);
        return Li(n + 36 * e / (e + 38))
    }
      , Mi = function(e) {
        var t, i, n = [], s = (e = function(e) {
            for (var t = [], i = 0, n = e.length; i < n; ) {
                var s = e.charCodeAt(i++);
                if (s >= 55296 && s <= 56319 && i < n) {
                    var r = e.charCodeAt(i++);
                    56320 == (64512 & r) ? t.push(((1023 & s) << 10) + (1023 & r) + 65536) : (t.push(s),
                    i--)
                } else
                    t.push(s)
            }
            return t
        }(e)).length, r = 128, a = 0, o = 72;
        for (t = 0; t < e.length; t++)
            (i = e[t]) < 128 && n.push(Ii(i));
        var l = n.length
          , c = l;
        for (l && n.push("-"); c < s; ) {
            var u = Ai;
    ...
    var Fi = function(e) {
      ...
      , cn = function() {
        oi(this, cn, Vi);
        var e, t, i, n, s, r, a, o, l, c = arguments.length > 0 ? arguments[0] : void 0, u = this, h = [];
        if (zi(u, {
            type: Vi,
            entries: h,
            updateURL: function() {},
            ...
            if (g(c))
                if ("function" == typeof (e = Si(c)))
                    for (i = (t = e.call(c)).next; !(n = i.call(t)).done; ) {
                        if ((a = (r = (s = Fi(C(n.value))).next).call(s)).done || (o = r.call(s)).done || !r.call(s).done)
                ...
                rn(h, "string" == typeof c ? "?" === c.charAt(0) ? c.slice(1) : c : c + "")
    }
      , un = cn.prototype;
    !function(e, t, i) {
        for (var n in t)
        ...
        set: function(e, t) {
            on(arguments.length, 1);
            for (var i, n = Ki(this), s = n.entries, r = !1, a = e + "", o = t + "", l = 0; l < s.length; l++)
                (i = s[l]).key === a && (r ? s.splice(l--, 1) : (r = !0,
                i.value = o));
            r || s.push({
                key: a,
                value: o
        ...
        sort: function() {
            var e, t, i, n = Ki(this), s = n.entries, r = s.slice();
            for (s.length = 0,
            i = 0; i < r.length; i++) {
                for (e = r[i],
                t = 0; t < i; t++)
        ...
        forEach: function(e) {
            for (var t, i = Ki(this).entries, n = hi(e, arguments.length > 1 ? arguments[1] : void 0, 3), s = 0; s < i.length; )
    ...
    ee(un, Bi, un.entries),
    ee(un, "toString", (function() {
        for (var e, t = Ki(this).entries, i = [], n = 0; n < t.length; )
            e = t[n++],
            i.push(sn(e.key) + "=" + sn(e.value));
        return i.join("&")
    }
    ), {
        enumerable: !0
    ...
    ai || "function" != typeof Di || "function" != typeof Hi || xe({
        ...
        fetch: function(e) {
            var t, i, n, s = [e];
            return arguments.length > 1 && (g(t = arguments[1]) && (i = t.body,
            ki(i) === Vi && ((n = t.headers ? new Hi(t.headers) : new Hi).has("content-type") || n.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"),
            t = Ut(t, {
                body: c(0, String(i)),
                headers: c(0, n)
            }))),
    ...
    var hn, dn = {
        URLSearchParams: cn,
        getState: Ki
    }, pn = lt.codeAt, mn = n.URL, fn = dn.URLSearchParams, gn = dn.getState, yn = Z.set, bn = Z.getterFor("URL"), vn = Math.floor, wn = Math.pow, kn = "Invalid scheme", Tn = "Invalid host", Sn = "Invalid port", En = /[A-Za-z]/, An = /[\d+-.A-Za-z]/, Cn = /\d/, Pn = /^(0x|0X)/, xn = /^[0-7]+$/, Ln = /^\d+$/, In = /^[\dA-Fa-f]+$/, _n = /[\u0000\t\u000A\u000D #%/:?@[\\]]/, On = /[\u0000\t\u000A\u000D #/:?@[\\]]/, Mn = /^[\u0000-\u001F ]+|[\u0000-\u001F ]+$/g, Nn = /[\t\u000A\u000D]/g, Rn = function(e, t) {
        var i, n, s;
        if ("[" == t.charAt(0)) {
            ...
            if (t = function(e) {
                var t, i, n = [], s = e.toLowerCase().replace(Pi, ".").split(".");
                for (t = 0; t < s.length; t++)
                    i = s[t],
                    n.push(Ci.test(i) ? "xn--" + Mi(i) : i);
                return n.join(".")
            }(t),
            _n.test(t))
                return Tn;
        ...
        n = 0; n < t; n++) {
            if ("" == (s = l[n]))
                return e;
            if (r = 10,
            s.length > 1 && "0" == s.charAt(0) && (r = Pn.test(s) ? 16 : 8,
            s = s.slice(8 == r ? 1 : 2)),
            "" === s)
                a = 0;
            else {
                if (!(10 == r ? Ln : 8 == r ? xn : In).test(s))
                    return e;
                a = parseInt(s, r)
            }
            i.push(a)
        ...
        var t, i, n, s, r, a, o, l = [0, 0, 0, 0, 0, 0, 0, 0], c = 0, u = null, h = 0, d = function() {
            return e.charAt(h)
        };
        if (":" == d()) {
            if (":" != e.charAt(1))
    ...
    }, Jn = {}, Zn = {}, es = {}, ts = {}, is = {}, ns = {}, ss = {}, rs = {}, as = {}, os = {}, ls = {}, cs = {}, us = {}, hs = {}, ds = {}, ps = {}, ms = {}, fs = {}, gs = {}, ys = {}, bs = {}, vs = function(e, t, i, n) {
        var s, r, a, o, l, c = i || Jn, u = 0, h = "", d = !1, p = !1, m = !1;
        for (i || (e.scheme = "",
        e.username = "",
        e.password = "",
        e.host = null,
        ...
        s = Ei(t); u <= s.length; ) {
            ...
            case Zn:
                if (r && (An.test(r) || "+" == r || "-" == r || "." == r))
                    ...
                    if (i && (Wn(e) != v(Vn, h) || "file" == h && (zn(e) || null !== e.port) || "file" == e.scheme && !e.host))
                        return;
                    if (e.scheme = h,
                    i)
                        return void (Wn(e) && Vn[e.scheme] == e.port && (e.port = null));
                    h = "",
                    "file" == e.scheme ? c = hs : Wn(e) && n && n.scheme == e.scheme ? c = ts : Wn(e) ? c = rs : "/" == s[u + 1] ? (c = is,
                ...
                if (!Cn.test(r)) {
                    if (r == hn || "/" == r || "?" == r || "#" == r || "\\" == r && Wn(e) || i) {
                        if ("" != h) {
                            ...
                            if (b > 65535)
                                return Sn;
                            e.port = Wn(e) && b === Vn[e.scheme] ? null : b,
                            h = ""
                        }
                        if (i)
                            return;
            ...
            case hs:
                ...
                "/" == r || "\\" == r)
                    ...
                    if (r == hn)
                        ...
                        if ("#" != r) {
                            Gn(s.slice(u).join("")) || (e.host = n.host,
                            e.path = n.path.slice(),
                            Xn(e)),
                            c = fs;
                            continue
            ...
            case ds:
                ...
                n && "file" == n.scheme && !Gn(s.slice(u).join("")) && (Yn(n.path[0], !0) ? e.path.push(n.path[0]) : e.host = n.host),
                c = fs;
                continue;
            case ps:
                if (r == hn || "/" == r || "\\" == r || "?" == r || "#" == r) {
            ...
            case fs:
                if (r == hn || "/" == r || "\\" == r && Wn(e) || !i && ("?" == r || "#" == r)) {
                    if (".." === (l = (l = h).toLowerCase()) || "%2e." === l || ".%2e" === l || "%2e%2e" === l ? (Xn(e),
                    "/" == r || "\\" == r && Wn(e) || e.path.push("")) : Qn(h) ? "/" == r || "\\" == r && Wn(e) || e.path.push("") : ("file" == e.scheme && !e.path.length && Yn(h) && (e.host && (e.host = ""),
                    h = h.charAt(0) + ":"),
                    e.path.push(h)),
                    h = "",
            ...
            case gs:
                "?" == r ? (e.query = "",
                c = ys) : "#" == r ? (e.fragment = "",
                c = bs) : r != hn && (e.path[0] += Bn(r, qn));
                break;
            case ys:
                i || "#" != r ? r != hn && ("'" == r && Wn(e) ? e.query += "%27" : e.query += "#" == r ? "%23" : Bn(r, qn)) : (e.fragment = "",
                c = bs);
                break;
            case bs:
        ...
        var t, i, n = oi(this, ws, "URL"), s = arguments.length > 1 ? arguments[1] : void 0, a = String(e), o = yn(n, {
            type: "URL"
        });
        if (void 0 !== s)
            if (s instanceof ws)
                t = bn(s);
            else if (i = vs(t = {}, String(s)))
                throw TypeError(i);
        if (i = vs(o, a, null, t))
            throw TypeError(i);
            ...
            var t = e.URL
              , i = function(t, i) {
                ...
                if (i && (void 0 === e.location || i !== e.location.href)) {
                    i = i.toLowerCase(),
                    (n = (s = document.implementation.createHTMLDocument("")).createElement("base")).href = i,
    ...
    var sr = function() {
        function e(t, i) {
            ...
            er(this.element) && ir(this.element.rangeTouch) && (this.config = Ds({}, Hs, {}, i),
            this.init())
        }
        return function(e, t, i) {
            ...
            value: function(t) {
                if (!e.enabled || !tr(t))
                    return null;
                var i, n = t.target, s = t.changedTouches[0], r = parseFloat(n.getAttribute("min")) || 0, a = parseFloat(n.getAttribute("max")) || 100, o = parseFloat(n.getAttribute("step")) || 1, l = n.getBoundingClientRect(), c = 100 / l.width * (this.config.thumbWidth / 2) / 100;
            ...
            key: "set",
            value: function(t) {
                e.enabled && tr(t) && !t.target.disabled && (t.preventDefault(),
            ...
            value: function(t) {
                var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
                  , n = null;
                if (ir(t) || Qs(t) ? n = Array.from(document.querySelectorAll(Qs(t) ? t : 'input[type="range"]')) : er(t) ? n = [t] : Zs(t) ? n = Array.from(t) : Js(t) && (n = t.filter(er)),
                ir(n))
                    return null;
                var s = Ds({}, Hs, {}, i);
                if (Qs(t) && s.watch) {
    ...
    function Fr(e, t) {
        return Tr(t) && Tr(t.parentNode) && Tr(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function Dr(e, t) {
        if (!yr(e) || xr(e))
    ...
    function Br(e, t, i) {
        if (kr(e))
            return Array.from(e).map((e=>Br(e, t, i)));
        if (Tr(e)) {
            let n = "toggle";
    ...
    function Jr(e, t, i, n=!1, s=!0, r=!1) {
        if (!e || !("addEventListener"in e) || xr(t) || !vr(i))
            return;
        const a = t.split(" ");
        let o = r;
        Qr && (o = {
    ...
    const ca = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce(((e,[t,i])=>({
        ...e,
        [t / i]: [t, i]
    })), {});
    function ua(e) {
        if (!(wr(e) || yr(e) && e.includes(":")))
            return !1;
    ...
    function pa(e) {
        ...
        const [n,s] = ha(i)
          , r = 100 / n * s;
        if (la(`aspect-ratio: ${n}/${s}`) ? t.style.aspectRatio = `${n}/${s}` : t.style.paddingBottom = `${r}%`,
    ...
    const fa = {
                ...
                set(t) {
                    if (e.quality !== t) {
                        if (e.config.quality.forced && vr(e.config.quality.onChange))
                            ...
                            ("none" !== r || a) && (e.once("loadedmetadata", (()=>{
                                e.speed = o,
                                e.currentTime = n,
                                s || ra(e.play())
                            }
        ...
        cancelRequests() {
            this.isHTML5 && (Ur(fa.getSources.call(this)),
    ...
    const ka = {
      ...
      , Ta = {
        get(e="", t={}) {
            ...
            let i = Or(t.i18n, e);
            if (xr(i))
                return Object.keys(ka).includes(e) ? ka[e] : "";
            const n = {
                "{seektime}": t.seekTime,
                "{title}": t.title
            };
    ...
    const xa = {
        ...
        findElements() {
            try {
                return this.elements.controls = Kr.call(this, this.config.selectors.controls.wrapper),
                ...
                Tr(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(`.${this.config.classNames.tooltip}`)),
                !0
            } catch (e) {
        ...
        createButton(e, t) {
            ...
            Object.keys(i).includes("class") ? i.class.split(" ").some((e=>e === this.config.classNames.control)) || Mr(i, {
            ...
            Rr(r, i),
            "play" === n ? (wr(this.elements.buttons[n]) || (this.elements.buttons[n] = []),
        ...
        bindMenuItemShortcuts(e, t) {
            Zr.call(this, e, "keydown keyup", (i=>{
                ...
                if (!n && [32, 39].includes(i.which))
                    ...
                    Tr(t) || (t = e.parentNode.firstElementChild)) : (t = e.previousElementSibling,
        ...
        createMenuItem({value: e, list: t, type: i, title: n, badge: s=null, checked: r=!1}) {
            ...
            Object.defineProperty(o, "checked", {
                ...
                set(e) {
                    e && Array.from(o.parentNode.children).filter((e=>Wr(e, '[role="menuitemradio"]'))).forEach((e=>e.setAttribute("aria-checked", "false"))),
        ...
        updateVolume() {
            this.supported.ui && (Tr(this.elements.inputs.volume) && xa.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            Tr(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange(e, t=0) {
            Tr(e) && (e.value = t,
            xa.updateRangeFill.call(this, e))
        },
        updateProgress(e) {
            if (!this.supported.ui || !Sr(e))
                return;
            let t = 0;
            const i = (e,t)=>{
                const i = gr(t) ? t : 0
            ...
            if (e)
                ...
                case "seeked":
                    ...
                    "timeupdate" === e.type && xa.setRange.call(this, this.elements.inputs.seek, t);
                    break;
                case "playing":
                case "progress":
        ...
        updateSeekTooltip(e) {
            if (!this.config.tooltips.seek || !Tr(this.elements.inputs.seek) || !Tr(this.elements.display.seekTooltip) || 0 === this.duration)
                return;
            ...
            if (Sr(e))
                ...
                if (!Vr(this.elements.display.seekTooltip, t))
                    return;
                n = parseFloat(this.elements.display.seekTooltip.style.left, 10)
            }
            n < 0 ? n = 0 : n > 100 && (n = 100),
            xa.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * n),
        ...
        timeUpdate(e) {
            ...
            xa.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
            e && "timeupdate" === e.type && this.media.seeking || xa.updateProgress.call(this, e)
        },
        durationUpdate() {
            if (!this.supported.ui || !this.config.invertTime && this.currentTime)
                return;
            if (this.duration >= 2 ** 32)
                return Hr(this.elements.display.currentTime, !0),
            ...
            !e && this.config.displayDuration && this.paused && xa.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
            e && xa.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
        ...
        updateSetting(e, t, i) {
            ...
            if (Tr(r) || (r = n && n.querySelector('[role="menu"]')),
            !Tr(r))
                return;
        ...
        setQualityMenu(e) {
            if (!Tr(this.elements.settings.panels.quality))
                return;
            const t = "quality"
            ...
            if (xa.toggleMenuButton.call(this, t, n),
            qr(i),
        ...
        setCaptionsMenu() {
            if (!Tr(this.elements.settings.panels.captions))
                return;
            const e = "captions"
              , t = this.elements.settings.panels.captions.querySelector('[role="menu"]')
              , i = _a.getTracks.call(this)
              , n = Boolean(i.length);
            if (xa.toggleMenuButton.call(this, e, n),
            qr(t),
            xa.checkMenu.call(this),
            !n)
                return;
        ...
        setSpeedMenu() {
            if (!Tr(this.elements.settings.panels.speed))
                return;
            const e = "speed"
        ...
        toggleMenu(e) {
            ...
            s && Er(e) ? xa.focusFirstMenuItem.call(this, null, !0) : s || n || Yr.call(this, i, Er(e))
        },
        getMenuSize(e) {
        ...
        showMenuPanel(e="", t=!1) {
            ...
            Hr(s, !0),
            Hr(i, !1),
            xa.focusFirstMenuItem.call(this, i, t)
        },
        setDownloadUrl() {
        ...
        create(e) {
            const {bindMenuItemShortcuts: t, createButton: i, createProgress: n, createRange: s, createTime: r, setQualityMenu: a, setSpeedMenu: o, showMenuPanel: l} = xa;
            this.elements.controls = null,
            wr(this.config.controls) && this.config.controls.includes("play-large") && this.elements.container.appendChild(i.call(this, "play-large"));
            ...
            return aa(wr(this.config.controls) ? this.config.controls : []).forEach((a=>{
                if ("restart" === a && c.appendChild(i.call(this, "restart", u)),
                ...
                if ("current-time" === a && c.appendChild(r.call(this, "currentTime", u)),
                ...
                if ("captions" === a && c.appendChild(i.call(this, "captions", u)),
                "settings" === a && !xr(this.config.settings)) {
                    ...
                    this.config.settings.forEach((i=>{
                        ...
                        u.appendChild(jr("span", {
                            "aria-hidden": !0
                        }, Ta.get(i, this.config))),
                        u.appendChild(jr("span", {
                            class: this.config.classNames.hidden
                        }, Ta.get("menuBack", this.config))),
                        Zr.call(this, c, "keydown", (e=>{
                ...
                if ("pip" === a && Xr.pip && c.appendChild(i.call(this, "pip", u)),
        ...
        inject() {
            ...
            Tr(this.config.controls) || yr(this.config.controls) ? e = this.config.controls : (e = xa.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            yr(this.config.selectors.controls.container) && (n = document.querySelector(this.config.selectors.controls.container)),
            Tr(n) || (n = this.elements.container);
            if (n[Tr(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e),
    ...
    const _a = {
        setup() {
            ...
            if (!this.isVideo || this.isYouTube || this.isHTML5 && !Xr.textTracks)
                return void (wr(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && xa.setCaptionsMenu.call(this));
            var e, t;
            if (Tr(this.elements.captions) || (this.elements.captions = jr("div", Dr(this.config.selectors.captions)),
            ...
            if (br(s) || ({active: s} = this.config.captions),
        ...
        update() {
            ...
            (r && this.language !== i || !e.includes(s)) && (_a.setLanguage.call(this, i),
            _a.toggle.call(this, t && r)),
            Br(this.elements.container, this.config.classNames.captions.enabled, !xr(e)),
            wr(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && xa.setCaptionsMenu.call(this)
        },
        toggle(e, t=!0) {
            if (!this.supported.ui)
                return;
        ...
        getLabel(e) {
            let t = e;
            return !Ar(t) && Xr.textTracks && this.captions.toggled && (t = _a.getCurrentTrack.call(this)),
            Ar(t) ? xr(t.label) ? xr(t.language) ? Ta.get("enabled", this.config) : e.language.toUpperCase() : t.label : Ta.get("disabled", this.config)
        },
        updateCues(e) {
            if (!this.supported.ui)
                return;
    ...
    class Fa {
        constructor(e) {
            ...
            $s(this, "update", (()=>{
                if (this.enabled) {
                    let e;
                    e = this.forceFallback ? "Fallback (forced)" : Fa.native ? "Native" : "Fallback",
            ...
            Zr.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : `${this.prefix}fullscreenchange`, (()=>{
                this.onChange()
            }
            )),
        ...
        static get prefix() {
            if (vr(document.exitFullscreen))
                return "";
            let e = "";
            return ["webkit", "moz", "ms"].some((t=>!(!vr(document[`${t}ExitFullscreen`]) && !vr(document[`${t}CancelFullScreen`])) && (e = t,
            !0))),
            e
        }
        static get property() {
    ...
    const Ha = {
        ...
        build() {
            ...
            Tr(this.elements.controls) || (xa.inject.call(this),
            ...
            Br(this.elements.container, this.config.classNames.pip.supported, Xr.pip && this.isHTML5 && this.isVideo),
            Br(this.elements.container, this.config.classNames.airplay.supported, Xr.airplay && this.isHTML5),
            ...
            this.poster && Ha.setPoster.call(this, this.poster, !1).catch((()=>{}
            )),
            this.config.duration && xa.durationUpdate.call(this)
        },
        setTitle() {
            let e = Ta.get("play", this.config);
            if (yr(this.config.title) && !xr(this.config.title) && (e += `, ${this.config.title}`),
        ...
        setPoster(e, t=!0) {
            ...
            sa.call(this).then((()=>Da(e))).catch((t=>{
                throw e === this.poster && Ha.togglePoster.call(this, !1),
                t
            }
            )).then((()=>{
                if (e !== this.poster)
        ...
        constructor(e) {
            $s(this, "firstTouch", (()=>{
                const {player: e} = this
                  , {elements: t} = e;
                e.touch = !0,
                Br(t.container, e.config.classNames.isTouch, !0)
            }
            )),
            ...
            $s(this, "global", ((e=!0)=>{
                ...
                Jr.call(t, document.body, "keydown focus blur focusout", this.setTabFocus, e, !1, !0)
            }
            )),
            $s(this, "container", (()=>{
                const {player: e} = this
                  , {config: t, elements: i, timers: n} = e;
                !t.keyboard.global && t.keyboard.focused && Zr.call(e, i.container, "keydown keyup", this.handleKey, !1),
                Zr.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t=>{
                    const {controls: s} = i;
                    s && "enterfullscreen" === t.type && (s.pressed = !1,
                    s.hover = !1);
                    let r = 0;
                    ["touchstart", "touchmove", "mousemove"].includes(t.type) && (Ha.toggleControls.call(e, !0),
                    r = e.touch ? 3e3 : 2e3),
                    clearTimeout(n.controls),
                    n.controls = setTimeout((()=>Ha.toggleControls.call(e, !1)), r)
                }
                ));
                const s = ()=>{
                    ...
                    if (!n)
                        return void (a ? (t.style.width = null,
                ...
                Zr.call(e, i.container, "enterfullscreen exitfullscreen", (t=>{
                    ...
                    if (n !== i.container)
                        return;
                    if (!e.isEmbed && xr(e.config.ratio))
                        return;
                    s();
            ...
            $s(this, "media", (()=>{
                const {player: e} = this
                  , {elements: t} = e;
                if (Zr.call(e, e.media, "timeupdate seeking seeked", (t=>xa.timeUpdate.call(e, t))),
                Zr.call(e, e.media, "durationchange loadeddata loadedmetadata", (t=>xa.durationUpdate.call(e, t))),
                Zr.call(e, e.media, "ended", (()=>{
                    e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(),
                    e.pause())
                }
                )),
                Zr.call(e, e.media, "progress playing seeking seeked", (t=>xa.updateProgress.call(e, t))),
                Zr.call(e, e.media, "volumechange", (t=>xa.updateVolume.call(e, t))),
                Zr.call(e, e.media, "playing play pause ended emptied timeupdate", (t=>Ha.checkPlaying.call(e, t))),
                Zr.call(e, e.media, "waiting canplay seeked playing", (t=>Ha.checkLoading.call(e, t))),
            ...
            $s(this, "controls", (()=>{
                ...
                this.bind(t.buttons.settings, "keyup", (t=>{
                    ...
                    t.stopPropagation(),
                    xa.toggleMenu.call(e, t)) : xa.focusFirstMenuItem.call(e, null, !0))
                }
                ), null, !1),
                ...
                this.bind(t.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (t=>{
                    ...
                    r && a ? (i.removeAttribute(s),
                    ra(e.play())) : !a && e.playing && (i.setAttribute(s, ""),
                    e.pause())
                }
                )),
                _r.isIos) {
                ...
                this.bind(t.progress, "mouseenter mouseleave mousemove", (t=>xa.updateSeekTooltip.call(e, t))),
                ...
                this.bind(t.controls, "focusin", (()=>{
                    ...
                    clearTimeout(n.controls),
                    n.controls = setTimeout((()=>Ha.toggleControls.call(e, !1)), s)
                }
                )),
        ...
        handleKey(e) {
            ...
            if (s) {
                ...
                if (Tr(s)) {
                    ...
                    if (s !== r && Wr(s, n))
                        return;
                    if (32 === e.which && Wr(s, 'button, [role^="menuitem"]'))
                        return
                }
    ...
    var Va = t((function(e, t) {
        e.exports = function() {
            ...
            function o(t, i, n, s) {
                var r, a, l = document, c = n.async, u = (n.numRetries || 0) + 1, h = n.before || e, d = t.replace(/[\?|#].*$/, ""), p = t.replace(/^(css|img)!/, "");
                s = s || 0,
    ...
    const Ka = {
        setup() {
            ...
            e.options.speed = e.config.speed.options,
            pa.call(e),
            fr(window.Vimeo) ? Ka.ready.call(e) : Wa(e.config.urls.vimeo.sdk).then((()=>{
                Ka.ready.call(e)
            }
            )).catch((t=>{
        ...
        ready() {
            ...
            e.media.play = ()=>(za.call(e, !0),
            e.embed.play()),
            e.media.pause = ()=>(za.call(e, !1),
            e.embed.pause()),
            e.media.stop = ()=>{
                e.pause(),
                e.currentTime = 0
            ...
            Object.defineProperty(e.media, "currentTime", {
                ...
                set(t) {
                    ...
                    n.seeking = !0,
                    ia.call(e, n, "seeking"),
                    Promise.resolve(a && i.setVolume(0)).then((()=>i.setCurrentTime(t))).then((()=>a && i.pause())).then((()=>a && i.setVolume(r))).catch((()=>{}
                    ))
                }
            });
    ...
    const Xa = {
        setup() {
            if (Br(this.elements.wrapper, this.config.classNames.embed, !0),
                ...
                events: {
                    ...
                    onReady(i) {
                        ...
                        e.timers.buffering = setInterval((()=>{
                            ...
                            (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && ia.call(e, e.media, "progress"),
                    ...
                    onStateChange(i) {
                        ...
                        case 0:
                            ...
                            n.playVideo()) : ia.call(e, e.media, "ended");
                            break;
                        case 1:
                            t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (Ya.call(e, !0),
                            ia.call(e, e.media, "playing"),
      ...
      , Qa = {
        setup() {
            this.media ? (Br(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            Br(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
            this.isEmbed && Br(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
            this.isVideo && (this.elements.wrapper = jr("div", {
            ...
            this.isHTML5 ? fa.setup.call(this) : this.isYouTube ? Xa.setup.call(this) : this.isVimeo && Ka.setup.call(this)) : this.debug.warn("No media element found!")
        }
    };
    class Ja {
        constructor(e) {
            ...
            $s(this, "on", ((e,t)=>(wr(this.events[e]) || (this.events[e] = []),
            ...
            $s(this, "clearSafetyTimer", (e=>{
                mr(this.safetyTimer) || (this.player.debug.log(`Safety timer cleared from: ${e}`),
    ...
    class to {
        constructor(e) {
            ...
            $s(this, "startScrubbing", (e=>{
                (mr(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0,
            ...
            $s(this, "endScrubbing", (()=>{
                this.mouseDown = !1,
                Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(!1) : ta.call(this.player, this.player.media, "timeupdate", (()=>{
            ...
            $s(this, "render", (()=>{
                ...
                Tr(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container),
    ...
    const io = {
        ...
        change(e) {
            Or(e, "sources.length") ? (fa.cancelRequests.call(this),
            this.destroy.call(this, (()=>{
                ...
                Qa.setup.call(this),
                this.isHTML5 && Object.keys(e).includes("tracks") && io.insertElements.call(this, "track", e.tracks),
                (this.isHTML5 || this.isEmbed && !this.supported.ui) && Ha.build.call(this),
                this.isHTML5 && this.media.load(),
                xr(e.previewThumbnails) || (Object.assign(this.config.previewThumbnails, e.previewThumbnails),
                this.previewThumbnails && this.previewThumbnails.loaded && (this.previewThumbnails.destroy(),
                this.previewThumbnails = null),
                this.config.previewThumbnails.enabled && (this.previewThumbnails = new to(this))),
    ...
    class no {
        constructor(e, t) {
            if ($s(this, "play", (()=>vr(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((()=>this.ads.play())).catch((()=>ra(this.media.play()))),
            ...
            $s(this, "stop", (()=>{
                ...
                this.restart()) : vr(this.media.stop) && this.media.stop()
            }
            )),
            $s(this, "restart", (()=>{
                this.currentTime = 0
            ...
            $s(this, "toggleControls", (e=>{
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (n && wr(this.config.controls) && this.config.controls.includes("settings") && !xr(this.config.settings) && xa.toggleMenu.call(this, !1),
                    n !== t) {
            ...
            $s(this, "destroy", ((e,t=!1)=>{
                ...
                const i = ()=>{
                    ...
                    this.embed = null,
                    t ? (Object.keys(this.elements).length && (Ur(this.elements.buttons.play),
                ...
                this.isHTML5 ? (Ha.toggleNativeControls.call(this, !0),
            ...
            (window.jQuery && this.media instanceof jQuery || kr(this.media) || wr(this.media)) && (this.media = this.media[0]),
            this.config = Mr({}, Oa, no.defaults, t || {}, (()=>{
                try {
            ...
            Tr(this.elements.container) || (this.elements.container = jr("div", {
                tabindex: 0
            }),
            ...
            Ha.addStyleHook.call(this),
            Qa.setup.call(this),
            this.config.debug && Zr.call(this, this.elements.container, this.config.events.join(" "), (e=>{
            ...
            this.lastSeekTime = 0,
            this.config.previewThumbnails.enabled && (this.previewThumbnails = new to(this))) : this.debug.error("Setup failed: no support")
        }
        get isHTML5() {
        ...
        set download(e) {
            Pr(e) && (this.config.urls.download = e,
            xa.setDownloadUrl.call(this))
        }
        set poster(e) {
            this.isVideo ? Ha.setPoster.call(this, e, !1).catch((()=>{}
        ...
        set ratio(e) {
            this.isVideo ? yr(e) && ua(e) ? (this.config.ratio = ha(e),
            pa.call(this)) : this.debug.error(`Invalid aspect ratio specified (${e})`) : this.debug.warn("Aspect ratio can only be set for video")
        }
        set autoplay(e) {
        ...
        set pip(e) {
            ...
            vr(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Ma : Na),
            vr(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
        }
        get pip() {
        ...
        static setup(e, t={}) {
            let i = null;
            return yr(e) ? i = Array.from(document.querySelectorAll(e)) : kr(e) ? i = Array.from(e) : wr(e) && (i = e.filter(Tr)),
            xr(i) ? null : i.map((e=>new no(e,t)))
        }
    }
    var so;
    return no.defaults = (so = Oa,
    JSON.parse(JSON.stringify(so))),
    no
}
));
